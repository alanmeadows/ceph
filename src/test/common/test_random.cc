...
TEST(util, test_user_mutex)
{
  ...
  ceph::util::generate_random_number(double(20.0), l);
  ceph::util::generate_random_number(double(1.0), double(20.0), l);
}
...
TEST(util, test_random_user_rng_lock)
{
  ...
  ceph::util::generate_random_number(double(20.0), l, e);
  ceph::util::generate_random_number(double(1.0), double(20.0), l, e);
}
